...
# created by Justin Haag 9/16/2023
@author: D99003734
"""
...
def add_stock(stock_list):
    ...
    while option != "0":
      ...
      option = input("Press Enter to add another stock or press 0 to end: ")
...
def import_stock_csv(stock_list):
    print("\nAdd historical data to a stock in the list--:")
    print("Stock List [ ", end="")
    for stock in stock_list:
        print(stock.symbol, " ", end="")
    print ("]")
...
def display_report(stock_list):
    ...
    print("Stock Report--:")
    for stock in stock_list:
        print("Stock Report for: ", stock.name, stock.symbol)
        ...
        if count > 0:
            print("Summary--: ")
            print("Low price is: ${:,.2f}".format(lowPrice))
            print("High price is: ${:,.2f}".format(highPrice))
            print("Average price is: ${:,.2f}".format(price_total / count))
            print("Low volume is: ", lowVolume)
            print("High volume is: ", highVolume)
            print("Average volume is: {:,.2f}".format(volume_total / count))
            print("Change in price is: ${:,.2f}".format(priceChange))
            print("Profit/loss is: ${:,.2f}".format(priceChange * stock.shares))
        else:
